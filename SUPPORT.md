...
Thanks for using `wickra-verify`. Here is where to go for help.
...
- Open a [GitHub Discussion](https://github.com/wickra-lib/wickra-verify/discussions)
  for questions and ideas.

## Bugs and feature requests

Open a [GitHub issue](https://github.com/wickra-lib/wickra-verify/issues) using
...
`wickra-verify` is a research and engineering tool: it evaluates conditions
